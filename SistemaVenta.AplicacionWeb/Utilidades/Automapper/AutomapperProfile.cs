    ...
    public class AutomapperProfile : Profile
    {
        public AutomapperProfile()
        {
            ...
            CreateMap<Negocio, VMNegocio>().
                ...
                opt => opt.MapFrom(origen => Convert.ToString(origen.PorcentajeImpuesto.Value, new CultureInfo
                ("es-Me")))
                );
            ...
            CreateMap<VMNegocio, Negocio>().
               ForMember(destino =>
               destino.PorcentajeImpuesto,
               opt => opt.MapFrom(origen => Convert.ToDecimal(origen.PorcentajeImpuesto, new CultureInfo
               ("es-Me")))
               );
            #endregion
