...
namespace SistemaVenta.BLL.Implementacion
{
    ...
    public class UsuarioService : UsuarioServiceBase, IUsuarioService
    {
        ...
        private readonly IUsuarioService _utilidadesService;
        private readonly ICorreoService _correoService;

        public UsuarioService(

            IGenericRepository<Usuario> repositorio,
            IFireBaseServices fireBaseService,
            IUsuarioService utilidadesService,
        ...
        public string? ConvertirSha256(string clave_generada)
        {
